      ...
      <div className="my-14">
        <div className="w-100 space-y-5">
          ...
          <div className="xl:gri mt-14 grid grid-cols-1 gap-4  px-10 md:grid-cols-2">
            <CategoryCard
              className="rounded-[15px] bg-mens p-[40px] text-center text-2xl font-bold text-white cursor-pointer"
              name="Men's Clothing"
              page="/category/mens"
            />
            <CategoryCard
              className="rounded-[15px] bg-womens p-[40px] text-center text-2xl font-bold text-white cursor-pointer"
